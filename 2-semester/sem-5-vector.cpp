...
vect::vect()
{
    ...
    dim = 0;
    v = new double[dim];
    cout << "Конструктор vect() создал вектор N " << num << endl;
}
...
vect::vect(int d)
{
    count++; //count = count + 1
    num = count;
    cout << "Конструктор vect(int d) создал вектор N " << num << endl;
    dim = d;
    v = new double[dim];
    for (int i = 0; i < dim; i++)
    {
...
vect::vect(int d, double* x)
{
    count++;
    num = count;
    cout << "Конструктор vect(int d, double* x) создал вектор N " << num << endl;
    dim = d;
    v = x;
    for (int i = 0; i < dim; i++)
    {
...
vect::vect(vect& x)
{
    count++; //count = count + 1
    num = count;
    cout << "Конструктор vect(vect& x) создал вектор N " << num << endl;
